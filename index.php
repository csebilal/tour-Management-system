		...
		<div id="section-5" class="contact section">
			<div class="contact-head text-center">
				...
				<div class="col-md-4 address">
					<h4 style="color:#09F">RK TOUR & TRAVELS</h4>
					<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
		            For fantastic suggestions you may also call our travel expert</p>
					<h5 style="color:#000"><span class="img1"></span>(+91) 7890591157&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;(+91) 6290626683</h5>
					<h5 style="color:#000"><span class="img2"></span><a href="#">info@rahul.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;support@rahul.com</a></h5>
					<h5 style="color:#000"><span class="img3"></span>Vizag RK Beach</h5>
		            <br/>
